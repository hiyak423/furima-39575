class User < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :last_name, format: { with: /\A[ぁ-んァ-ン一-龠々]/, message: 'Input full-width characters' }
    validates :first_name, format: { with: /\A[ぁ-んァ-ン一-龠々]/, message: 'Input full-width characters' }
